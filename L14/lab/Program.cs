...
namespace lab
{
    public class Program
    {
        ...
        public IEnumerable<KeyValuePair<ControlElement, string>> LINQElementAndItsFuntion(Stack<Dictionary<ControlElement, ControlElement>> app, List<Function> funcs) =>
            from window in app
            from element in window
        ...
        public IEnumerable<KeyValuePair<ControlElement, string>> EXTElementAndItsFuntion(Stack<Dictionary<ControlElement, ControlElement>> app, List<Function> funcs) =>
